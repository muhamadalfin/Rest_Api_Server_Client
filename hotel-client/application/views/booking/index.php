...
<div class="shadow-lg p-5 bg-white rounded">
    ...
    <input type="hidden" class="form-control" name="id_kamar" id="id_kamar" value="<?= $kamar['id_kamar']?>" >
    <input type="hidden" class="form-control" name="id_pengunjung" id="id_pengunjung" value="<?= $pengunjung['id_pengunjung']?>" >
        <div class="form-row">
