...
<div class="row mt-3">
    <div class="col-md-6">
        ...
        <center><table class="table-reservasi" >
            ...
            <tr>
                <td align = "center"><?php echo $rs['id_reservasi']?></td>
                <td align = "center"><?php echo $rs['nama']?></td>
                <td align = "center"><?php echo $rs['ktp']?></td>
                <td align = "center"><?php echo $rs['tlp']?></td>
                <td align = "center"><?php echo $rs['alamat']?></td>
                <td align = "center"><?php echo $rs['no_kamar']?></td>
